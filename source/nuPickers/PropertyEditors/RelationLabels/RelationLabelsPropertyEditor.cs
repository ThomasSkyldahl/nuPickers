...
namespace nuPickers.PropertyEditors.RelationLabels
{
    ...
    // EDITOR UI
    [DataEditor(PropertyEditorConstants.RelationLabelsAlias, "nuPickers: Relation Labels", EmbeddedResource.ROOT_URL + "Labels/LabelsEditor.html", ValueType = "TEXT")]
    ...
    public class RelationLabelsPropertyEditor : BasePropertyEditor<RelationLabelsConfigurationEditor>
    {
