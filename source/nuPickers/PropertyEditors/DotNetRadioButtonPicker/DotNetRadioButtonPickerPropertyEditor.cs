...
namespace nuPickers.PropertyEditors.DotNetRadioButtonPicker
{
    ...
    // EDITOR UI
    [DataEditor(PropertyEditorConstants.DotNetRadioButtonPickerAlias, "nuPickers: DotNet RadioButton Picker", EmbeddedResource.ROOT_URL + "RadioButtonPicker/RadioButtonPickerEditor.html", ValueType = "TEXT")]
