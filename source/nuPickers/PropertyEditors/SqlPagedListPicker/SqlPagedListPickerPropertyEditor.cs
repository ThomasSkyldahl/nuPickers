...
namespace nuPickers.PropertyEditors.SqlPagedListPicker
{
    ...
    // EDITOR UI
    [DataEditor(PropertyEditorConstants.SqlPagedListPickerAlias, "nuPickers: Sql PagedList Picker", EmbeddedResource.ROOT_URL + "PagedListPicker/PagedListPickerEditor.html", ValueType = "TEXT")]
