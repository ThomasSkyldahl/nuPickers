...
namespace nuPickers.PropertyEditors.JsonTypeaheadListPicker
{
    ...
    public class JsonTypeaheadPickerPropertyEditor : BasePropertyEditor<JsonTypeaheadListPickerConfigurationEditor>
    {
        public JsonTypeaheadPickerPropertyEditor(ILogger logger) : base(logger)
        {
        }
    }
}