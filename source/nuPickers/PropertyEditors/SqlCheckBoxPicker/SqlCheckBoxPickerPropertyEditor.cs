...
namespace nuPickers.PropertyEditors.SqlCheckBoxPicker
{
    ...
    // EDITOR UI
    [DataEditor(PropertyEditorConstants.SqlCheckBoxPickerAlias, "nuPickers: Sql CheckBox Picker", EmbeddedResource.ROOT_URL + "CheckBoxPicker/CheckBoxPickerEditor.html", ValueType = "TEXT")]
