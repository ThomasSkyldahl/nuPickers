...
namespace nuPickers.PropertyEditors.SqlRadioButtonPicker
{
    ...
    // EDITOR UI
    [DataEditor(PropertyEditorConstants.SqlRadioButtonPickerAlias, "nuPickers: Sql RadioButton Picker", EmbeddedResource.ROOT_URL + "RadioButtonPicker/RadioButtonPickerEditor.html", ValueType = "TEXT")]
    ...
    public class SqlRadioButtonPickerPropertyEditor : BasePropertyEditor<SqlRadioButtonPickerConfigurationEditor>
    {
        public SqlRadioButtonPickerPropertyEditor(ILogger logger) : base(logger)
        {
        }
    }
}
